...
const main = async (msg, args, id) => {
   ...
   // console.log(medico + " " + cidade + " " + id);
    ...
    for (var j = 2; j < 5; j++) {
        ...
        var text5 = $('#search-content > div > ul > li:nth-child('+j+') > div.panel.panel-default > div > div > div.col-md-6.result-column.padding-2.padding-left-3.padding-xs-left-3.padding-xs-left-3.padding-xs-right-3.padding-xs-right-3 > div.dp-doctor-card.dp-doctor-card-md > div.offset-top-1.hidden-xs > div > em > span').text();
