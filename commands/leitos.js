...
const main = async (msg, args) => {
    ...
    const url = "https://covid-insumos.saude.gov.br/paineis/insumos/painel_leitos.php";
    const content = await fetchData(url);
    const $ = cheerio.load(content)


    const totalGlobo = $('#map > div.leaflet-control-container > div.leaflet-top.leaflet-right > div').text();
   console.log(" x"+totalGlobo);
